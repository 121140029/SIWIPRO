...
<head>
    ...
    <title>SIWIPRO | @yield('title')</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand fixed-top" style="background: #19292A">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li style="margin-bottom: -20px; margin-left:20px">
                    <h4 class="text-white fw-bold">
                        Sistem Informasi Website Profil dan Informasi Produk
                    </h4>
                    <p class="text-white fw-bold" style="margin-top:-10px;">
                        PT. Tunas Jaya Lautan
                    </p>
                </li>                
            </ul>
        ...
        <aside class="main-sidebar elevation-4" style="background:#19292A">
            <!-- Brand Logo -->
            <a href="#" class="brand-link text-center">
                <div style="color: #ffffff; font-family: 'Roboto', sans-serif">
                    <div class="fw-bold" style="font-size: 20px">SIWIPRO</div>
                </div>
            </a>
