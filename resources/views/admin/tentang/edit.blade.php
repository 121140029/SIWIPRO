<button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modalEditTentang{{ $item->id }}">
    <i class="fas fa-edit"></i>
</button>

<div class="modal fade" id="modalEditTentang{{ $item->id }}" tabindex="-1" role="dialog">
